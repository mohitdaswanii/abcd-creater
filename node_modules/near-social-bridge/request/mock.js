 ...
 * @returns
 */
export var createMockUser = function (defaultValues) {
    var userFirstName = (defaultValues === null || defaultValues === void 0 ? void 0 : defaultValues.firstName) || randName();
    var userLastName = (defaultValues === null || defaultValues === void 0 ? void 0 : defaultValues.lastName) || randName();
    var linktree = userFirstName.toLowerCase();
    return {
        accountId: (defaultValues === null || defaultValues === void 0 ? void 0 : defaultValues.accountId) || "".concat(randUserName(userFirstName, userLastName), ".near").toLowerCase(),
        profileInfo: {
            backgroundImage: {
 ...
 */
export var mockInitialPayload = function (initialPayload) {
    globalMock[LOCAL_MOCK_KEYS.INITIAL_PAYLOAD] = function () { return initialPayload; };
};
/**
 ...
 */
export var getMockedResponse = function (requestType, payload) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        return [2 /*return*/, new Promise(function (resolve) {
                var _a;
                if (isDevelopment && isLocalDev && Object.keys(globalMock).length > 0) {
                    var response_1 = (_a = globalMock[requestType]) !== null && _a !== void 0 ? _a : null;
                    setTimeout(function () {
 ...
 */
export var createMock = function (requestType, handler) {
 ...
 * @returns
 */
export var setupMock = function (options) { return (mockOptions = __assign(__assign({}, mockOptions), options)); };
/**
 * Mock authenticated user. You can use `createMockUser()` method to provide the user object
 * @param userInfo
 * @returns
 */
export var mockUser = function (userInfo) { return createMock(REQUEST_KEYS.AUTH_GET_USER_INFO, function () { return userInfo; }); };
